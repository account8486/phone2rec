...
CREATE TABLE `base_module_title` (
  ...
  `terminal_type` varchar(10) DEFAULT NULL COMMENT '终端类型',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=101 DEFAULT CHARSET=utf8 COMMENT='基础模块标题';
...
CREATE TABLE `card` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COMMENT='RFID卡片信息';
...
) ENGINE=InnoDB AUTO_INCREMENT=9416 DEFAULT CHARSET=utf8 COMMENT='分组计划成员表';
...
CREATE TABLE `hotel_room` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `meeting_id` int(11) DEFAULT NULL,
  `hotel_room_type_id` int(11) DEFAULT NULL,
...
CREATE TABLE `issue_card` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='RFID卡片发放信息';
...
CREATE TABLE `local_specialty` (
  ...
  `city` varchar(20) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=utf8 COMMENT='全局级别的土特产信息';
...
CREATE TABLE `meeting` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=157 DEFAULT CHARSET=utf8 COMMENT='会议组织人员通过会务组织管理模块进行会议创建，会议创建包括确定会议名称、会议主要议题、会议规模、会议开始和结束时间、会议';
...
) ENGINE=InnoDB AUTO_INCREMENT=81 DEFAULT CHARSET=utf8 COMMENT='dinner_section： 1 早餐  2 中餐 3 晚餐\r\ndinner_type：1自助餐 2 桌餐';
...
CREATE TABLE `meeting_files` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=10128 DEFAULT CHARSET=utf8 COMMENT='上传的会议文件资料';
...
CREATE TABLE `meeting_files_assort` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8 COMMENT='会议资料分类列表';
...
CREATE TABLE `meeting_module_title` (
  ...
  `terminal_type` varchar(10) DEFAULT NULL COMMENT '终端类型',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=289 DEFAULT CHARSET=utf8 COMMENT='会议模块标题';
...
CREATE TABLE `meeting_specialty` (
  ...
  `city` varchar(20) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COMMENT='会议下面创建的本地特产信息';
...
) ENGINE=InnoDB AUTO_INCREMENT=58 DEFAULT CHARSET=utf8 COMMENT='机构表';
...
CREATE TABLE `sign_in` (
  ...
  KEY `meeting_id_idx` (`meeting_id`),
  KEY `user_id_idx` (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=8306 DEFAULT CHARSET=utf8 COMMENT='签到表';
...
CREATE TABLE `spokesman` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=59 DEFAULT CHARSET=utf8 COMMENT='会议发言人';
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='RFID卡片标签触发任务';
...
) ENGINE=InnoDB AUTO_INCREMENT=4435 DEFAULT CHARSET=utf8;
...
CREATE TABLE `user_login_log` (
  ...
  `portal_type` smallint(6) DEFAULT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=6479 DEFAULT CHARSET=utf8;
