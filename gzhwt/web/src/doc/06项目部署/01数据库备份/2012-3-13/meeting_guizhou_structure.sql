...
CREATE TABLE `local_specialty` (
  ...
  `city` varchar(20) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=31 DEFAULT CHARSET=utf8 COMMENT='全局级别的土特产信息';
...
CREATE TABLE `meeting` (
  ...
  PRIMARY KEY (`id`) 
) ENGINE=InnoDB AUTO_INCREMENT=162 DEFAULT CHARSET=utf8 COMMENT='会议组织人员通过会务组织管理模块进行会议创建，会议创建包括确定会议名称、会议主要议题、会议规模、会议开始和结束时间、会议';
...
CREATE TABLE `meeting_files` (
  ...
  PRIMARY KEY (`id`) 
) ENGINE=InnoDB AUTO_INCREMENT=10133 DEFAULT CHARSET=utf8 COMMENT='上传的会议文件资料';
...
CREATE TABLE `meeting_specialty` (
  ...
  `city` varchar(20) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COMMENT='会议下面创建的本地特产信息';
...
CREATE TABLE `news` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8 COMMENT='新闻信息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=61 DEFAULT CHARSET=utf8 COMMENT='机构表';
...
CREATE TABLE `sign_in` (
  ...
  KEY `meeting_id_idx` (`meeting_id`),
  KEY `user_id_idx` (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=8324 DEFAULT CHARSET=utf8 COMMENT='签到表';
...
CREATE TABLE `spokesman` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=66 DEFAULT CHARSET=utf8 COMMENT='会议发言人';
...
CREATE TABLE `user_login_log` (
  ...
  `portal_type` smallint(6) DEFAULT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=6527 DEFAULT CHARSET=utf8;
