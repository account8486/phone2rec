...
CREATE TABLE `card` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='RFID卡片信息';
...
CREATE TABLE `issue_card` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='RFID卡片发放信息';
...
CREATE TABLE `local_specialty` (
  ...
  `city` varchar(20) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=utf8 COMMENT='全局级别的土特产信息';
...
CREATE TABLE `meeting` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=169 DEFAULT CHARSET=utf8 COMMENT='会议组织人员通过会务组织管理模块进行会议创建，会议创建包括确定会议名称、会议主要议题、会议规模、会议开始和结束时间、会议';
...
) ENGINE=InnoDB AUTO_INCREMENT=87 DEFAULT CHARSET=utf8 COMMENT='dinner_section： 1 早餐  2 中餐 3 晚餐\r\ndinner_type：1自助餐 2 桌餐';
...
CREATE TABLE `meeting_files` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10145 DEFAULT CHARSET=utf8 COMMENT='上传的会议文件资料';
...
CREATE TABLE `meeting_specialty` (
  ...
  `city` varchar(20) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8 COMMENT='会议下面创建的本地特产信息';
...
CREATE TABLE `news` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=utf8 COMMENT='新闻信息表';
...
CREATE TABLE `sign_in` (
  ...
  KEY `meeting_id_idx` (`meeting_id`),
  KEY `user_id_idx` (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=8375 DEFAULT CHARSET=utf8 COMMENT='签到表';
...
CREATE TABLE `user_login_log` (
  ...
  `portal_type` smallint(6) DEFAULT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=6631 DEFAULT CHARSET=utf8;
