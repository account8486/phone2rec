	    ...
	    <fieldset>
	        ...
	        <c:if test="${contentType == 3}">
		        ...
		        <dl>
		            ...
		            <dd>
		            	<input style="width:15%" class="half" type="text" id="content_sortNo" name="content.sortNo"  value="${content.sortNo}" maxlength="2"/>
		            	<font id="tip_mobile" style="line-height:35px" color="red"></font>
		        ...
		        <dl>
		            ...
		            <dd>
		             ...
		             <input style="width:30px;"  type="checkbox" id="content_category" name="category" value="touch" ${content.inTouch ? 'checked':''}/>TOUCH
		            	<font id="tip_mobile" style="line-height:35px" color="red"></font>
