...
%>
	...
	<div class="page_title">
		<h3>行程分组管理  -- ${CURRENT_MEETING}</h3>
	</div>
	<div class="page_form">
	<form id="chooseGroupPlanForm" action="${ctx}/admin/pri/meeting/doChooseJourneyGroupPlan.action" method="post" >
	...
	<script type="text/javascript">
		...
		function submit(){
			//alert('${meeting.id}');
			var url = '${ctx}/admin/pri/journey/doChooseJourneyGroupPlan.action';
		...
		function returnList(){
			window.location.href = "${ctx}/admin/pri/journey/listJourney.action?meetingId=${journey.meetingId}";
		}
