...
<c:if test="${contentType == 3}">
	...
	<div class="easyui-tabs" border="false" style="padding:10px;">
		<div title="系统菜单" link="${ctx}/admin/pri/basemenu/getBaseMenuPages.action?meetingId=${meetingId}" style="padding:10px;"></div>
		<div title="定制菜单"  style="padding:10px;" selected="true">
