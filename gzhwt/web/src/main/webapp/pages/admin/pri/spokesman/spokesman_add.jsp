...
function add(){	   
	...
	function returnList(meetingId){
		window.location.href = "${ctx}/admin/pri/spokesman/getSpokesManLst.action?meetingId="+meetingId;
	}
	    ...
	    <fieldset>
	        <legend>基本信息</legend>
	          <dl>
	            ...
	            <dd>
	            	<input type="text"  id="name" name="name" value="" tabindex="2" maxlength="30"></input>	            	
	            </dd>
	        </dl>	
	        ...
	        <dl>
	            ...
	            <dd>
	            	<input type="text"  onkeyup="value=value.replace(/[^\d]/g,'')" id="mobile" name="mobile"  tabindex="1" maxlength="11"></input>
	       ...
	       <dl>
	            ...
	            <dd>
	            	<select class="inp_1" id="gender" name="gender" tabindex="5" style="width:20%;">
