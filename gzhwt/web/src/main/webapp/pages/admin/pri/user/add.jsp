	...
	<form id="addUserForm" action="${ctx}/admin/pri/user/add.action" method="post">
	    <fieldset>
	        ...
	        <dl>
	            ...
	            <dd>
	            	<select class="inp_1" id="role" name="user.role.id" tabindex="5" style="width:16%;">
						<c:forEach var="role" items="${roleList}" varStatus="status">
							<option value="${role.id }">${role.roleName }</option>
						</c:forEach>
					</select>
					<font id="tip_role" style="line-height:35px" color="red"></font>
					<select class="inp_1" id="canOrg" name="user.canOrg" tabindex="5" style="display:none;width:16%;">
	          ...
	          <dl>
	            ...
	            <dd>
	            	<select class="inp_1" id="role" name="user.securityRoleId" tabindex="5" style="width:16%;">
	    ...
	    <fieldset>
	        ...
	        <dl>
	            ...
	            <dd>
	            	<select class="inp_1" id="user.gender" name="user.gender" tabindex="7" style="width:16%;">
