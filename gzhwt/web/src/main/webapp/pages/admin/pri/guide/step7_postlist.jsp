...
<body>
	...
	<div class=page_title><h3>互动管理 -- ${CURRENT_MEETING}</h3></div>
	<div class="easyui-tabs" border="false" style="padding:10px;">
		<div title="互动交流" style="padding:0px 10px;"></div>
		<input type="hidden" name="guideStep" value="step7" />
		<input type="hidden" id="stepValue" name="stepValue" value="7"/>
		<%--
	...
	<div style="padding:0px 10px; width:95%;">
	<form id="newpost" action="${ctx}/admin/pri/interaction/postCreate.action" enctype="multipart/form-data" method="POST">
		...
		<input type="hidden" name="fromStep" id="fromStep" value="step7"/>
			<p class="limit">
				<span class="tools">
			...
			<p><div class="emotionpanel"></div></p>
  		    ...
  		    <%--
         	<span class="sbm"><a href="${ctx}/pages/admin/pri/guide/step8_groupAdd.jsp?meetingId=${meetingId}" class="btn_common btn_true">下一步</a></span>
 			--%>
 			<span class="sbm"><a href="#" onclick="doFinish();" class="btn_common btn_true">结束向导</a></span>
	 		<span class="sbm"><a href="javascript:void(0);return false;" id="postAdd" class="btn_common btn_true">发布信息</a></span>
	 	            <span class="sbm"><a href="${ctx}/admin/pri/meeting/guide_step6.action?fromStep=step7&meeting.id=${meetingId}" class="btn_common btn_true">上一步</a></span>
      	</div>
    </form>
