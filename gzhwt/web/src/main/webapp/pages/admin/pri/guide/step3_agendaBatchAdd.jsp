...
<body>
	...
	<div class="easyui-tabs" border="false" style="padding:10px;">
		...
		<table class="page_datalist" id="batch_add_table" >
	    	<thead>
				<tr>
					<th scope="col" width="90px">日期</th>
					<th scope="col" width="55px">开始时间</th>
					<th scope="col" width="55px">结束时间</th>
					<th scope="col" >人员</th>
					<th scope="col" >议题</th>
					<th scope="col" >地点</th>
					<th scope="col" >内容</th>
	    ...
	    <div class="page_form_sub">
				<div style="margin-bottom: 10px; margin-top: 10px;padding-left: 200px;" align="center">
				  ...
				  <a href="${ctx}/admin/pri/meeting/guide_step4.action?meeting.id=${meetingId}" class="btn_common btn_true">下一步</a>
...
<div style="clear: both"></div>
	...
	*/
	...
	function loadList(){
		//admin/pri/agenda/agendaList.action?meetingId=198
		var timeStamp=new Date().getTime();
		var url="${ctx}/admin/pri/agenda/agendaList.action?from=guide&meetingId=${meetingId}&timeStamp="+timeStamp;
		$("#list").load(url);
	}
