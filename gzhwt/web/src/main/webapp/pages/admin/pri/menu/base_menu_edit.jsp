	...
	<div class="page_form">
		<form id="updateFrm"
			...
			<fieldset>
				...
				<!-- 只针对手机客户端有效  -->
				<c:if test="${clientMenu.terminalType eq 'CLIENT'||clientMenu.terminalType eq 'TOUCH'}">
				<dl>
					<dt>
					...
					<dd>
						<c:if test="${not empty clientMenu.imgUrl}">
		            		<img id="content_icon" src="${serverUrl}${clientMenu.imgUrl }" width="48px" height="48px"/>
		            	</c:if>
