...
<div style="width: 75%;float:left;margin-left: 5px;margin-right: 20px;">
	...
	<form id="addMeetingDinnerForm" action="${ctx}/admin/pri/meeting/addMeetingDinner.action" method="post">
		<input type="hidden" name="guideStep" value="step6"/>
		<input type="hidden" id="stepValue" name="stepValue" value="6"/>
	    ...
	    <div class="page_form_sub">
	    	<div style="margin-bottom: 10px; margin-top: 10px;" align="left">
	    	 <a href="${ctx}/admin/pri/meeting/guide_step5.action?guideStep=step5&meeting.id=${meetingId}"   class="btn_common btn_true">上一步</a>
	    	 <a href="#" onclick="save();" id="submitBtn" class="btn_common btn_true">保存</a>　
	    	   <a href="${ctx}/admin/pri/meeting/guide_step7.action?meetingId=${meetingId}" class="btn_common btn_true">下一步</a>　
	        </div>
	    </div>
	</form>
	</div>
