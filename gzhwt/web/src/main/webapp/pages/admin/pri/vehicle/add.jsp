...
<body>
	...
	<form id="addForm" action="#" method="post">
	    ...
	    <fieldset>
	        ...
	        <dl>
	        	<dt>
	            	<label for="title">&nbsp;<font color="red">* </font>车牌号：</label>
	            </dt>
	            <dd>
	          ...
	          <dl>
	        	<dt>
	            	<label for="title"><font color="red">* </font>车辆品牌：</label>
	            </dt>
	            <dd>
	          ...
	          <dl>
	            ...
	            <dd>
	            	<wd:select name="vehicle.type" type="vehicle_type"
						nullLabel="--无--" nullOption="true"
						selectedValue="${vehicle.type}"></wd:select>
	            </dd>
	        </dl>
	        ...
	        <dl>
	            ...
	            <dd>
	            	<input  type="text"  id="vehicle_capacity" tabindex="3" name="vehicle.capacity"  value="${vehicle.capacity}" maxlength="4" onkeyup="value=value.replace(/[^\d]/g,'')"/>
	            	<font id="tip_password" style="line-height:35px" color="red"></font>
	                <small></small>
	            </dd>
	        </dl>
	...
	<script type="text/javascript">
		...
		function validate()
		{    
			 var vehicleNumber=$.trim($("#vehicle_number").val());
