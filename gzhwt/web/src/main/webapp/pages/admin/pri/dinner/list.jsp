...
<head>
    ...
    ${jquery_js}
    ${util_js}
    ${WdatePicker_js} <script type="text/javascript" src="${ctx}/js/easyui/jquery.easyui.js"></script>
</head>
<body>
	<div class="page_title">
		<h3>会议用餐  -- ${CURRENT_MEETING}</h3>
	</div>
	<div class="easyui-tabs" border="false" style="padding:10px;">
		<div title="用餐管理" style="padding:10px;" selected="true">
	...
	<div title="批量添加" link="${ctx}/admin/pri/meeting/gotoBatchAddDinner.action?meetingId=${meetingId}" style="padding:10px;">
