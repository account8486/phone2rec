...
<body>
	...
	<div class="easyui-tabs" border="false" style="padding:10px;">
			...
			<form id="queryFrm"
				...
				<div class="page_tools page_toolbar" style="text-align: left;">
					...
					<wd:select name="terminalType" type="terminal_type"
						...
						selectedValue="${terminalType}" style="width:200px;"></wd:select>
		...
		<div title="定制菜单" link="${ctx}/admin/pri/meeting/listMeetingContent.action?contentType=3&meetingId=${meetingId}" style="padding:10px;"></div>
		<div title="权限配置" link="${ctx}/pages/admin/pri/menu/member_level_list.jsp?meetingId=${meetingId}" style="padding:10px;"></div>
		<div title="访问统计" link="${ctx}/admin/pri/statistics/menuStatics.action?meetingId=${meetingId}" style="padding:10px;"></div>
	</div>
</body>
</html>