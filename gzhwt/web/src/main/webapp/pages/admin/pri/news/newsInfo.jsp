...
<body>
	...
	<form id="addNewsForm" action="${ctx}/admin/pri/news/save.action" method="post" enctype="multipart/form-data">
	    ...
	    <fieldset>
	        ...
	        <dl style="display:${not empty news ? '' : 'none'};">
	       	...
	       	<dl>
	            ...
	            <dd>
	            	<textarea  style="width:98%" id="editor"  name="news.content" >${wd:base64Decode(news.content)}</textarea>
	    ...
	    <div class="page_form_sub">
	        ...
	        <a href="${ctx }/admin/pri/news/list.action?meetingId=${meetingId}" id="retUserListBtn" class="btn_common btn_false">返回</a>
	    </div>
	</form>
	</div>
