...
<body>
	...
	<div class="easyui-tabs" border="false" style="padding:10px;">
		...
		<div title="自动发卡" link="${ctx }/admin/pri/meeting/card_listIssue.action?meetingId=${meetingId}" style="padding:10px;"></div>
		<%--
...
<script type="text/javascript">
	...
	// 返回列表
	function returnList(){
		window.location.href = "${ctx}/admin/pri/meeting/card_queryOwner.action?meetingId=${meetingId}";
	}
