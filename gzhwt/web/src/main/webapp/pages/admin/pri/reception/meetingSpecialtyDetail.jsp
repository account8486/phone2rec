...
<body>
	<div class="page_title" style="display:block"><h3>管理土特产信息  -- ${CURRENT_MEETING}</h3></div>
	<div class="easyui-tabs" border="false" style="padding:10px;">	
		<div title="新闻管理" link="${ctx}/admin/pri/news/list.action?meetingId=${meetingId}" style="padding:10px;"></div>
		<div title="管理土特产信息" selected="true"  style="padding:10px;">
		<s:if test="specialty != null">
			<div class="page_datalist" style="width:98%; border:1px dashed #000000; padding:10px; margin:10px 0;">
				...
				<div style="text-align:right; padding-right:10px;">
					...
					<a href="${ctx}/admin/pri/reception/specialty_preview.action?meetingId=${meetingId}">预览</a>
