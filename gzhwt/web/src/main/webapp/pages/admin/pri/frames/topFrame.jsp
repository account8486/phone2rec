...
<div class="header">
    ...
    <div class="nav">
    	<ul>
            ...
            <li><a id="manual"  href="/appbook.doc">操作手册</a></li>
        </ul>
    </div>
    <div class="user">
    	欢迎您！<span class="name">${SESSION_ADMIN_USER.name}</span>(${SESSION_ADMIN_USER.role.roleName})
    </div>
</div>
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#mymeeting").bind("click", function(){
			mainFrame.src="${ctx}/admin/pri/meeting/listMeeting.action";
		});	
	});
</script>
