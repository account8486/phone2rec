...
<body>
		...
		<table class="page_datalist" id="batch_add_table" >
	    	<thead>
				<tr>
					...
					<th scope="col" width="60px" >地点</th>
					<th scope="col" width="70px">操作</th>
				</tr>	    	
	        </thead>
	        <tbody class="page_form5">
	         <tr>
	...
	function loadList(){
		...
		var url="${ctx}/admin/pri/meeting/listMeetingDinner.action?from=guide&meetingId=${meetingId}&timeStamp="+timeStamp;
		$("#list").load(url);
	}
	/**
	*删除当前行
