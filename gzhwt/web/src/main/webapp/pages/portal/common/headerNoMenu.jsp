    	...
    	<ul class="title">
            <li class="iepng">
            	<div style="width:108px; height:53px;">
	            	...
	            	<img src="${sessionScope.meeting_logo_image_url }" width="108" height="53" border="0"/>
	            	</s:if>
            	</div>
            </li>
            <li style="margin-top:5px; padding-left:100px;"><h3 title="${meeting.name}">${fn:escapeXml(meeting.name)}</h3></li>
        </ul>
        <div class="detail">
...
<div class="nav" style="height:8px;">
</div>
