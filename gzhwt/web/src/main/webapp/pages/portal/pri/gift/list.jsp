<%@ page language="java" contentType="text/html; charset=UTF-8"   pageEncoding="UTF-8"%>
	...
	<div class="container w960" style="min-height:300px;">
		...
		<c:forEach var="gift" items="${pager.pageRecords}" varStatus="status">
			<div class="goods">
				<div class="pic"><a href="${ctx}/portal/pri/gift/detail.action?id=${gift.id}&meetingId=${meetingId}&menu_id=${param.menu_id}"><img width="180px" height="177px" src="${serverUrl}${gift.imgUrl }" /></a></div>
