...
public class AdminUser extends BaseObject {
	...
	private Integer state;// 用户状态 0：无效，1：有效，-1：已删除
	...
	private Integer canOrg;// 可以管理组织机构；0：不可以，1：可以
	private Integer securityRoleId;//菜单角色
	
	private boolean selected = false;// 临时使用字段
	...
	public Integer getCanOrg() {
		return canOrg;
	}

	public void setCanOrg(Integer canOrg) {
		this.canOrg = canOrg;
	}
