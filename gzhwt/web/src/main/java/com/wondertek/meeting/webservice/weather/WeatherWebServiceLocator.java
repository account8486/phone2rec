...
package com.wondertek.meeting.webservice.weather;

public class WeatherWebServiceLocator extends org.apache.axis.client.Service implements com.wondertek.meeting.webservice.weather.WeatherWebService {

/**
 * <a href="http://www.webxml.com.cn/" target="_blank">WebXml.com.cn</a>
 * <strong>天气预报 Web 服务，</strong>数据来源于<strong>中国气象局</strong> <a href="http://www.cma.gov.cn/"
 * target="_blank">http://www.cma.gov.cn/</a> ，数据每2.5小时左右自动更新一次，准确可靠。包括
 * 340 多个中国主要城市和 60 多个国外主要城市三日内的天气预报数据。</br>此天气预报Web Services请不要用于任何商业目的，若有需要请<a
 ...
 */
    ...
    private java.lang.String WeatherWebServiceSoap_address = "http://webservice.webxml.com.cn/WebServices/WeatherWebService.asmx";
    ...
    public com.wondertek.meeting.webservice.weather.WeatherWebServiceSoap_PortType getWeatherWebServiceSoap() throws javax.xml.rpc.ServiceException {
    ...
    public com.wondertek.meeting.webservice.weather.WeatherWebServiceSoap_PortType getWeatherWebServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.wondertek.meeting.webservice.weather.WeatherWebServiceSoap_BindingStub _stub = new com.wondertek.meeting.webservice.weather.WeatherWebServiceSoap_BindingStub(portAddress, this);
    ...
    private java.lang.String WeatherWebServiceSoap12_address = "http://webservice.webxml.com.cn/WebServices/WeatherWebService.asmx";
    ...
    public com.wondertek.meeting.webservice.weather.WeatherWebServiceSoap_PortType getWeatherWebServiceSoap12() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public com.wondertek.meeting.webservice.weather.WeatherWebServiceSoap_PortType getWeatherWebServiceSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.wondertek.meeting.webservice.weather.WeatherWebServiceSoap12Stub _stub = new com.wondertek.meeting.webservice.weather.WeatherWebServiceSoap12Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.wondertek.meeting.webservice.weather.WeatherWebServiceSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.wondertek.meeting.webservice.weather.WeatherWebServiceSoap_BindingStub _stub = new com.wondertek.meeting.webservice.weather.WeatherWebServiceSoap_BindingStub(new java.net.URL(WeatherWebServiceSoap_address), this);
                _stub.setPortName(getWeatherWebServiceSoapWSDDServiceName());
                return _stub;
            }
            if (com.wondertek.meeting.webservice.weather.WeatherWebServiceSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.wondertek.meeting.webservice.weather.WeatherWebServiceSoap12Stub _stub = new com.wondertek.meeting.webservice.weather.WeatherWebServiceSoap12Stub(new java.net.URL(WeatherWebServiceSoap12_address), this);
                _stub.setPortName(getWeatherWebServiceSoap12WSDDServiceName());
                return _stub;
            }
        }
    ...
    public java.rmi.Remote getPort(javax.xml.namespace.QName portName, Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        ...
        else if ("WeatherWebServiceSoap12".equals(inputPortName)) {
