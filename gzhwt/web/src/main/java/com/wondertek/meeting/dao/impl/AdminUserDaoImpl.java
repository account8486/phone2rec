...
public class AdminUserDaoImpl extends BaseDaoImpl<AdminUser, Long> implements AdminUserDao {
	...
	public String findPwdByMobile(String mobile) {
		String hql = "select b.password from AdminUser b where b.mobile = ? and b.state = 1";
	...
	public AdminUser selectByMobile(String mobile) {
		String sql = "from AdminUser b where b.mobile = ? and b.state = 1";
	...
	public AdminUser selectByAdminUsernameAndPwd(String adminUsername, String pwd) throws Exception {
		String sql = "from AdminUser b where b.mobile = ? and b.password = ? and b.state = 1";
	...
	public String changePwd(String adminUsername, String newPwd) {
		String sql = "from AdminUserInfo b where b.adminUsername = ? and b.state = 1";
	...
	public List<AdminUser> getAdminUsersByOrg(Long orgId, Long roleId) {
		String hql = "from AdminUser b where b.state=1 and b.org.id = ? and b.role.id = ? ";
		return this.getHibernateTemplate().find(hql, orgId, roleId);
	}
