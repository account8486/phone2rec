...
<form id="loginForm" action="${ctx}/portal/base/login.action" method="post">
	...
	<input class="uid" name="u.mobile" id="mobile"/><div class="uid"><font id="tip_mobile" style="display: none;" color="red"></font></div>
	<input class="psw" name="u.password" id="password" type="password" value="${u.password }" maxlength="20"/><font id="tip_password" style="display: none;" color="red"></font>
	<div class="btn_login">
        ...
        $.post(
                ...
                function (data, textStatus) {
                    if (textStatus == "success") {
                        ...
                        $("#tip_err_msg").html("对不起，获取密码失败，请稍候再试！");
                        $("#tip_err_msg").show();
                    }
