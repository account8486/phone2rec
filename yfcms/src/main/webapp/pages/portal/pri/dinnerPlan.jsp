	            	...
	            	<table id="info_${status.index }" class="content_table tableInfo" style="${fn:startsWith(dinnerInfo.date, today) ? '' : 'display:none'}">
	                    ...
	                    <tbody>
	                        ...
	                        <tr>
	                            ...
	                            <c:if test="${'自选座位' eq info.dinnerTable}">
			                	...
			                	<c:if test="${'自选座位' ne info.dinnerTable}"><a href="${ctx}/portal/pri/meeting/showGroupInfo.action?meetingId=${meetingId}&dinner.id=${info.dinnerId }&menu_id=${param.menu_id}">${info.dinnerTable}</a></c:if>
