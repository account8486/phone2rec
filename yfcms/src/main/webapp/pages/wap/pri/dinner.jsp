	            ...
	            <c:forEach var="info" items="${view.info}" varStatus="status">
		        	<li>
		                ...
		                <p>
			                ...
			                <c:if test="${'自选座位' ne info.dinnerTable}"><a href="${ctx}/wap/pri/meeting/showGroupInfo.action?meetingId=${meetingId}&dinner.id=${info.dinnerId }&menu_id=${param.menu_id}">${info.dinnerTable}</a></c:if>
		                </p>
