	        ...
	        <dl>
	         ...
	         <dl>
	           ...
	           <dl>
	            ...
	            <dd>
	        <input class="half" type="text" value="<c:if test="${not empty meetingSms.recipient}"><c:forEach  var="user" items="${meetingSms.recipient}" varStatus="status"> ${user.name}[${user.mobile}]</c:forEach></c:if>"/>     
