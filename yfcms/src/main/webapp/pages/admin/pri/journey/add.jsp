	...
	<form id="addForm" action="#" method="post">
	    ...
	    <fieldset>
	        ...
	        <dl>
	            ...
	            <dd>
	            	<input  type="text"  id="startTime" tabindex="2" name="startTime"  value="<fmt:formatDate value='${journey.startTime}' pattern='yyyy-MM-dd HH:mm'/>" class="Wdate" onfocus="WdatePicker({isShowClear:false,dateFmt:'yyyy-MM-dd HH:mm'})" readonly="readonly"/>
	        ...
	        <dl>
	            ...
	            <dd>
	            	<input  type="text"  id="journey_endTime" tabindex="4" name="endTime"  value="<fmt:formatDate value='${journey.endTime}' pattern='yyyy-MM-dd HH:mm'/>" class="Wdate" onfocus="WdatePicker({isShowClear:false,dateFmt:'yyyy-MM-dd HH:mm'})" readonly="readonly"/>
	            	<font id="tip_password" style="line-height:35px" color="red"></font>
	                <small></small>
	            </dd>
	        </dl>
