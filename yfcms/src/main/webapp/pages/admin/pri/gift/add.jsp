...
<body>
	...
	<div class="page_form">
	<form id="mainForm" action="${ctx}/admin/pri/gift/add.action" method="post" enctype="multipart/form-data"}>
	    ...
	    <fieldset>
	        ...
	        <dl>
	            ...
	            <dd>
	            	<input type="text" id="giftPrice" style="width: 50px" name="gift.price"  value="${gift.price}" maxlength="9" tabindex="2"/>元
	        ...
	        <dl>
	            ...
	            <dd>
	            	<textarea id="giftIntroduction" class="medium" name="gift.introduction" rows="5" tabindex="3">${gift.introduction }</textarea>
...
<script type="text/javascript">
	...
	function validateAdd() {
	    ...
	    var img = $("#img").val();
	    if (isEmpty(img)) {
    		$("#tip_img").html("请选择礼品图片。");
        	$("#tip_img").show();
        	result = false;
	    }else if (!/\.(gif|jpg|jpeg|png|GIF|JPG|PNG)$/.test(img.toLowerCase())) {
			$("#tip_img").html("图片类型必须是.gif,jpeg,jpg,png中的一种，请重新选择。");
        	$("#tip_img").show();
        	result = false;
	    }
