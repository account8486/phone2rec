	...
	<form id="addMeetingDinnerForm" action="${ctx}/admin/pri/meeting/addMeetingDinner.action" method="post">
	    ...
	    <fieldset>
	        ...
	        <dl>
	            ...
	            <dd>
	            	<select id="dinner_section" class="inp_1" tabindex="3" name="dinner.section" value="${dinner.section }">
	        ...
	        <dl>
	            ...
	            <dd>
	            	<input  type="text" id="startTime" tabindex="4" name="dinner.startTime"  value="${dinner.startTime}" class="Wdate" onfocus="WdatePicker({isShowClear:false,dateFmt:'HH:mm'})" readonly="readonly"/>
	            	<font id="tip_mobile" style="line-height:35px" color="red"></font>
	        ...
	        <dl>
	            ...
	            <dd>
	            	<input  type="text" id="endTime" tabindex="5" name="dinner.endTime"  value="${dinner.endTime}" class="Wdate" onfocus="WdatePicker({isShowClear:false,dateFmt:'HH:mm',minDate:'#F{$dp.$D(\'startTime\')||\'2020-10-01\'}'})" readonly="readonly"/>
	            	<font id="tip_mobile" style="line-height:35px" color="red"></font>
	        ...
	        <dl>
	            ...
	            <dd>
					<select class="inp_1" name="dinner.type" value="${dinner.type }" tabindex="6">
