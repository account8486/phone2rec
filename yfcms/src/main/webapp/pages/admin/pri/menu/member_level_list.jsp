...
<body>
    <div class=page_title><h3>菜单配置  -- ${CURRENT_MEETING}</h3></div>
	...
	<div class="easyui-tabs" border="false" style="padding:10px;">
		...
		<div title="菜单配置" style="padding:10px;" selected="true">
            <!-- 显示内容TABLE -->
		...
		<div title="菜单访问统计" link="${ctx}/admin/pri/statistics/menuStatics.action?meetingId=${param.meetingId}" style="padding:10px;"></div>
	</div>
</body>
</html>