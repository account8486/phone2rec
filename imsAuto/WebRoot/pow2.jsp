...
$(document).ready(function(){
	...
	addTips(obj2, info2);
		...
		<style type="text/css">
body {color:#fff;background:url(${appPath}/images/pow2.png) no-repeat; background-color: black; background-position: top center; }
	...
	<body>
		<div
			...
			<div id='db_1' class="back1"
				style="width: 46px; height: 79px; line-height: 62px; position: absolute; top: 398px; left: 192px;">
				爱默生UPS1
			</div>
			
			
			<div id='db_2' class="back1"
				style="width: 48px; height: 79px; line-height: 62px; position: absolute; top: 397px; left: 429px;">
				爱默生UPS2
			</div>
			
			
			<div id='db_3' class="back1"
				style="width:153px; height: 168px; line-height: 62px; position: absolute; top: 404px; left: 1026px;">
				市电总配电柜1
			</div>
			
			
			<div id='db_2' class="back1"
				style="width: 100px; height: 35px; line-height: 62px; position: absolute; top: 511px; left: 80px;">
				市电总配电柜2
			</div>
			
			<div id='db_2' class="back1"
				style="width: 75px; height: 30px; line-height: 62px; position: absolute; top: 517px; left: 525px;">
				市电总配电柜3
			</div>
