...
.main { border:4px solid #360; padding:0.5em 2em 0.5em 0em; }
...
var zhibiao = ["daikuan", "diubao", "delay_max", "delay_avg", "link"];
var zhibiaoName = ["网络带宽利用率", "网络丢包率", "网络延时峰值", "网络延时均值", "链路连通性"];


var data = [
	<c:if test="${not empty netlist}">
	<c:forEach items="${netlist}" begin="0" end="19" var="item" varStatus="state">
{deptName:"${item.deptName}", daikuan_sta:${item.daikuan_sta}, daikuan:"${item.daikuan}", diubao_sta:${item.diubao_sta}, diubao:"${item.diubao}", delay_max_sta:${item.delay_max_sta}, delay_max:"${item.delay_max}", delay_avg_sta:${item.delay_avg_sta}, delay_avg:"${item.delay_avg}", link_sta:${item.link_sta}, link:"${item.link}"}, </c:forEach>
	</c:if>
	{area:"", winxp:"", win2000:""} ];
...
<body>
<div class="title"><span>网络监管<span>
	<span>
...
<div class="main">
	...
	<tr id="daikuan">
		<td class="tar"><div>网络带宽利用率</div></td>
		<td class="bg_cross"><div><img src="${appPath}/images/lightGreen52.png" class="bubble" /></div></td>
		<td class="bg_cross"><div><img src="${appPath}/images/lightGreen52.png" class="bubble" /></div></td>
		<td class="bg_cross"><div><img src="${appPath}/images/lightGreen52.png" class="bubble" /></div></td>
		<td class="bg_cross"><div><img src="${appPath}/images/lightGreen52.png" class="bubble" /></div></td>
	...
	<tr id="delay_max">
		<td class="tar"><div>网络延时峰值</div></td>
		<td class="bg_cross"><div><img src="${appPath}/images/lightGreen52.png" class="bubble" /></div></td>
		<td class="bg_cross"><div><img src="${appPath}/images/lightGreen52.png" class="bubble" /></div></td>
		<td class="bg_cross"><div><img src="${appPath}/images/lightGreen52.png" class="bubble" /></div></td>
		<td class="bg_cross"><div><img src="${appPath}/images/lightGreen52.png" class="bubble" /></div></td>
	...
	<tr id="delay_avg">
		<td class="tar"><div>网络延时均值</div></td>
		<td class="bg_cross"><div><img src="${appPath}/images/lightGreen52.png" class="bubble" /></div></td>
		<td class="bg_cross"><div><img src="${appPath}/images/lightGreen52.png" class="bubble" /></div></td>
		<td class="bg_cross"><div><img src="${appPath}/images/lightGreen52.png" class="bubble" /></div></td>
		<td class="bg_cross"><div><img src="${appPath}/images/lightGreen52.png" class="bubble" /></div></td>
