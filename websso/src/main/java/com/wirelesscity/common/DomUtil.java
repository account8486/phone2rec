...
public class DomUtil {
	 ...
	 */
	public static Document addElementToElement(Document doc,String elementKey,String key,String value) throws XMLParseException{
	 ...
	 * @throws XMLParseException
	 */
	public static Document addAttributeToElement(Document doc,String elementKey,Map<String,String> keyValue) throws XMLParseException{
	...
	/**
	 * 从Document中中移除一个节点
	 * 注意：如果elementKey对应多个节点，那么这些节点都会被删除
	 * @param doc
	 * @param elementKey
	 */
	...
	/**
	 * 从一个节点中移除一个子节点
	 * 注意：如果elementKey对应多个节点，那么这些节点中的子节点都会被删除
	 * @param doc
	 * @param elementKey
	 * @param subElementKey
	 */
	...
	/**
	 * 从一个节点中移除一个属性
	 * 注意：如果elementKey对应多个节点，那么这些节点下的attriKey属性都会被删除
	 * @param doc
	 * @param elementKey
	 * @param attriKey
	 */
