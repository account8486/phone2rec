...
if (childMenuSet == null) childMenuSet = new mtDropDownSet(mtDropDown.direction.center, -5, 2, mtDropDown.reference.topRight);
...
elmCache["clip"].style.width = ow + mtDropDown.shadowSize + 600 + "px";
...
aHtml.join('') + 
'<tr><td colspan="2"><img src="' + mtDropDown.spacerGif + '" width="1" height="' + mtDropDown.menuPadding + '">123</td></tr></table>' + 
'<div class="shadowBottom"><img src="' + mtDropDown.spacerGif + '" width="1" height="1"></div>' + 
'<div class="shadowRight"><img src="' + mtDropDown.spacerGif + '" width="1" height="1"></div>' + 
'<div class="background"><img src="' + mtDropDown.spacerGif + '" width="1" height="1"></div>' + 
'</div></div>';
...
return '<td class="item" nowrap style="' + sPaddingLeft + '">' + 
sText + '</td><td class="item" width="0" style="' + sPaddingRight + '">' + 
'</td>';
}
}
