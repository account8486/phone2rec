...
mtDropDown.backgroundColor = "#0b8b7d"; 
...
elmCache["clip"].style.width = ow + mtDropDown.shadowSize + 635 + "px";
...
return '<td nowrap style="' + sPaddingLeft + '">' + '<a href="'+sUrl+'" target="'+sTag+'"><font color="#ffffff">'+
sText + '</font></a></td><td height="10" width="0" style="' + sPaddingRight + '">' + 
'|</td>';
}
}
